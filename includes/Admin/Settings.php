...
final class Settings
{
    ...
    {
        register_setting(self::OPTION_GROUP, 'aviflosu_enable_support', [
            'type' => 'boolean',
            'default' => true,
        ...
        register_setting(self::OPTION_GROUP, 'aviflosu_convert_on_upload', [
            'type' => 'boolean',
            'default' => true,
            'sanitize_callback' => 'rest_sanitize_boolean',
            'show_in_rest' => true,
        ...
        register_setting(self::OPTION_GROUP, 'aviflosu_convert_via_schedule', [
            'type' => 'boolean',
            'default' => true,
            'sanitize_callback' => 'rest_sanitize_boolean',
            'show_in_rest' => true,
        ...
        register_setting(self::OPTION_GROUP, 'aviflosu_schedule_time', [
            'type' => 'string',
            'default' => '01:00',
            'sanitize_callback' => [$this, 'sanitizeScheduleTime'],
            'show_in_rest' => true,
        ]);

        register_setting(self::OPTION_GROUP, 'aviflosu_quality', [
            'type' => 'integer',
            'default' => 85,
        ...
        register_setting(self::OPTION_GROUP, 'aviflosu_speed', [
            'type' => 'integer',
            'default' => 1,
            'sanitize_callback' => [$this, 'sanitizeSpeed'],
            'show_in_rest' => true,
        ]);

        register_setting(self::OPTION_GROUP, 'aviflosu_subsampling', [
            'type' => 'string',
            'default' => '420',
            'sanitize_callback' => [$this, 'sanitizeSubsampling'],
            'show_in_rest' => true,
        ]);

        register_setting(self::OPTION_GROUP, 'aviflosu_bit_depth', [
            'type' => 'string',
            'default' => '8',
            'sanitize_callback' => [$this, 'sanitizeBitDepth'],
            'show_in_rest' => true,
        ]);

        register_setting(self::OPTION_GROUP, 'aviflosu_cache_duration', [
            'type' => 'integer',
            'default' => 3600,
            'sanitize_callback' => 'absint',
            'show_in_rest' => true,
        ...
        register_setting(self::OPTION_GROUP, 'aviflosu_disable_memory_check', [
            'type' => 'boolean',
            'default' => false,
            'sanitize_callback' => 'rest_sanitize_boolean',
            'show_in_rest' => true,
        ...
        register_setting(self::OPTION_GROUP, 'aviflosu_engine_mode', [
            'type' => 'string',
            'default' => 'auto',
            'sanitize_callback' => [$this, 'sanitizeEngineMode'],
            'show_in_rest' => true,
        ]);

        register_setting(self::OPTION_GROUP, 'aviflosu_cli_path', [
            'type' => 'string',
            'default' => '',
        ...
        register_setting(self::OPTION_GROUP, 'aviflosu_cli_args', [
            'type' => 'string',
            'default' => '',
            'sanitize_callback' => 'sanitize_text_field',
            'show_in_rest' => true,
        ...
        register_setting(self::OPTION_GROUP, 'aviflosu_cli_env', [
            'type' => 'string',
            'default' => '',
            'sanitize_callback' => [$this, 'sanitizeCliEnv'],
            'show_in_rest' => true,
        ]);
    }
    ...
    private function registerFields(): void
    {
        ...
        add_settings_field(
            ...
            [$this, 'renderConvertOnUploadField'],
            self::PAGE_SLUG,
            'aviflosu_conversion',
        ...
        add_settings_field(
            ...
            [$this, 'renderDisableMemoryCheckField'],
            self::PAGE_SLUG,
            'aviflosu_conversion',
    ...
    {
        $v = (string) $value;
        return in_array($v, ['420', '422', '444'], true) ? $v : '420';
    }

    public function sanitizeBitDepth($value): string
    {
        $v = (string) $value;
        return in_array($v, ['8', '10', '12'], true) ? $v : '8';
    }

    public function sanitizeEngineMode($value): string
    {
        $v = (string) $value;
        return in_array($v, ['auto', 'cli', 'imagick', 'gd'], true) ? $v : 'auto';
    }
