    ...
    <div class="metabox-holder">
        ...
        <div class="postbox">
            ...
            <div class="inside">
                ...
                <div id="avif-local-support-logs-container">
                    <div id="avif-local-support-logs-content">
                        <?php
        ...
        <div class="postbox">
            ...
            <div class="inside">
                ...
                <div class="avif-support-panel">
                        ...
                        <tbody>
                            ...
                            <?php if ($engine_mode === 'auto'):
                                ...
                                <tr>
                                    ...
                                    <td><?php echo esc_html($first_label); ?><?php if ($auto_has_fallback): ?> <span
                    ...
                    <?php include __DIR__ . '/partials/engine-details.php'; ?>
